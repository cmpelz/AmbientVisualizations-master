...
function insertImg( imgSrc, divID, width, height ){
    ...
    var mapShape1 = '<area alt="" title="" href="javascript:changePic( 0 ), clickCode( 0 )" shape="poly" coords="48,310,45,293,44,280,42,265,40,247,40,231,40,212,40,198,41,178,44,159,46,140,50,127,57,122,68,121,84,118,98,117,116,119,130,120,141,121,154,124,164,126,169,133,167,145,166,157,165,169,163,183,162,197,160,214,159,229,157,242,156,255,155,266,153,282,152,294,151,302,150,308" />';
    var mapShape2 = '<area alt="" title="" href="javascript:changePic( 1 ), clickCode( 1 )" shape="poly" coords="200,1,200,37,193,38,197,44,171,59,178,64,185,64,195,65,214,65,230,63,233,58,205,42,209,37,203,37" />';
    var mapShape3 = '<area alt="" title="" href="javascript:changePic( 2 ), clickCode( 2 )"shape="poly" coords="420,137,413,146,414,159,533,163,533,158,528,156,521,144,501,137" />';
    var mapShape4 = '<area alt="" title="" href="javascript:changePic( 3 ), clickCode( 3 )" shape="poly" coords="420,210,415,212,412,218,412,230,423,230,420,305,535,305,532,229,522,228,521,216,515,210" />';
    var mapShape5 = '<area alt="" title="" href="javascript:changePic( 4 ), clickCode( 4 )" shape="poly" coords="539,199,543,226,540,229,586,229,585,225,589,207,586,201,580,199,547,196" />';
...
function clickCode( num ){
  ...
  if(fridge && light && rangehood && stove && toaster){
    document.getElementById("instructions").innerHTML = "Nice! The code word will appear in 15 seconds."
    setTimeout(codeWord,15000);
  }
}
function codeWord(){
  document.getElementById("instructions").innerHTML = "Code Word: Newspaper"
}

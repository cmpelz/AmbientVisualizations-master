...
#simulated version of fetch that assigns random energy and power values to each appliance
#only changes one appliance at a time, turning on off-appliances and turning off on-appliances
#best script to run when testing the visualization away from the kitchen
